...
${OBJECTDIR}/src/MemoryPool.o: src/MemoryPool.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MemoryPool.o src/MemoryPool.cpp

${OBJECTDIR}/src/MessageService.o: src/MessageService.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessageService.o src/MessageService.cpp

${OBJECTDIR}/src/Semaphore.o: src/Semaphore.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Semaphore.o src/Semaphore.cpp

${OBJECTDIR}/src/ServiceLocator.o: src/ServiceLocator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ServiceLocator.o src/ServiceLocator.cpp
...
${OBJECTDIR}/src/TimerInterval.o: src/TimerInterval.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TimerInterval.o src/TimerInterval.cpp
